...
//                 <Row>
//                     {cart.length === 0
//                         ? (<p>Cart is Empty <Link to="/">Go to Home</Link> </p>)
//                         : (
//                             <>
//                                 {cart.map((item) => (
...
//                                         <Card style={{ boxShadow: "0 2px 40px rgba(0, 0, 0, 0.1)", marginTop: "20px" }} >
//                                             <Card.Img variant="top" src={item.product_image} className="product-logo" />
//                                             <Card.Body>
//                                                 <Card.Subtitle className='product-top-head'>Breakfast Cereals, Snacks</Card.Subtitle>
//                                                 <Card.Title className='product-name'>
//                                                     {item.name}
//                                                 </Card.Title>
//                                                 <Card.Subtitle className='product-price'>${item.price}</Card.Subtitle>
//                                                 <ButtonGroup aria-label="Basic example">

//                                                     <Button variant="secondary" onClick={() => subQuantity(item)}>-</Button>
//                                                     <Button variant="secondary">{item.quantity}</Button>
//                                                     <Button variant="secondary" onClick={() => addQuantity(item)}>+</Button>
